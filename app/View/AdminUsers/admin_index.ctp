<div class="adminUsers index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $adminUser['AdminUser']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $adminUser['AdminUser']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
